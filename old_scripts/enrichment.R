...
write.table(go_enrich_filter$enrichmentP,
            "go_pmat_rosmap_full_V4.tsv",
            sep="\t")

# Save top GO terms per module summary
write.table(
  go_tab,
  "go_top_terms_rosmap_full_V4.csv",
  sep = ",",
  quote = FALSE,
  row.names = FALSE
)
